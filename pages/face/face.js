...
Page({
  ...
  touchStart: function (e) {
    ...
    if (this.isClear) { //判断是否启用的橡皮擦功能  ture表示清除  false表示画画
      ...
      this.context.save();  //保存当前整个context信息
  ...
  tphb: function(){
    wx.canvasToTempFilePath({
      x: 0,
      y: 0,
      width: app.globalData.canvasWidth,
      height: app.globalData.canvasHeight,
      destWidth: app.globalData.canvasWidth * 0.6,
      destHeight: app.globalData.canvasHeight * 0.6,
      canvasId: 'myCanvas',
